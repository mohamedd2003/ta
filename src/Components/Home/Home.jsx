          ...
          <div className="row  ">
            ...
            <div className={`col-lg-7`}>
              <div className="row g-3 ">
                <div className={`col-sm-6  px-md-0 px-sm-5 ${style.px}`}>
      ...
      <section id='works' className=' mt-xl-3 pt-xl-4    '>
        <div className="container py-5 mt-5">
          ...
          <Swiper
            ...
            className="mySwiper"
          >
            <SwiperSlide><img src={slide4} alt="" className='w-100 h-100 position-relative ' />
            ...
            <SwiperSlide><img src={slide2} alt="" className='w-100 h-100 ' /></SwiperSlide>
            <SwiperSlide><img src={slide3} alt="" className='w-100 h-100 ' /></SwiperSlide>
            <SwiperSlide><img src={slide4} alt="" className='w-100 h-100 ' /></SwiperSlide>
